...
const TABS = [
  ...
  { href: "/generate", label: "AI生成", icon: (active: boolean) => (
    <svg className="w-6 h-6" fill={active ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={active ? 0 : 1.5}>
...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-[#0d0d14]/90 backdrop-blur-md border-t border-white/8">
